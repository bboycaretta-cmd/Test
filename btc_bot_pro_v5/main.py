...
def test_all():
    ...
    try:
        from core import db
        # Database otomatik başlatılıyor, sadece import yeterli
        print("   ✅ Database OK")
...
def run_dashboard():
    ...
    try:
        from core.dashboard import BotDashboard, FLASK_AVAILABLE
        ...
        dashboard = BotDashboard(host='127.0.0.1', port=5000)
